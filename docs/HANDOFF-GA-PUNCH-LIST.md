...
three HIGH fixes in #516. Plan: [`design/plans/ENC-4-encoder-hud.md`](../design/plans/ENC-4-encoder-hud.md), 17 tasks.
...
⚠ **The implementation reached `main` without a PR and was never reviewed pre-merge**; #516 carries that review.
*Effort: 3–4 days.*
