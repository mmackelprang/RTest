...
2026-09-04** — the mirror direction of ADR-029's `D5` rule 2; see *Closed 2026-09-04 by the owner* below.
The board is still clear; only the date moved.
