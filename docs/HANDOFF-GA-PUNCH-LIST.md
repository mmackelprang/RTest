...
| **P1** | **37 listed, 36 open** | **`TEST-3`** (promoted from P2 2026-09-01 — it failed CI and blocked a merge), ~~`ENC-9`~~ (✅ **shipped 2026-09-03 — resolved by deletion; single-surface, local-only visualiser mode**), `ENC-14`, `AUD-2`, `AUD-5`, `AUD-10`, `AUD-11`, `AUD-12`, `LOG-2`, `LOG-3`, `LOG-4`, `LOG-5`, `LOG-6`, `LOG-7`, `LOG-8`, `LOG-11`, `PHN-3`, `PHN-4`, `TTS-2`, `TTS-3`, `TTS-4`, `TTS-5`, `TTS-6`, `TTS-7`, `TTS-8`, `GV-5`, `UI-2`, `UI-3`, `UI-4`, `UX-1`, `OPS-3`, `HW-2`, plus 5 cross-repo (`XR-1`…`XR-5`). |
